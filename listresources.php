      ...
      <div class="page-content">
        ...
        <section class="col-lg-12">
          <div class="block">
            ...
            <a href="#" data-toggle="modal" data-target="#participant-view" class="btn btn-light">Participant View</a>&emsp;
            <a href="add-resources.php" class="btn btn-primary"><i class="fa fa-add"></i>+ Add Resource</a>&emsp;
            <a href="deleted-listresources.php" class="btn btn-secondary">Deleted</a>
            </div>
            <br>
            <div>
        ...
        <!-- participant view start-->
        <div id="participant-view" tabindex="-1" role="dialog" aria-labelledby="login-modalLabel" aria-hidden="true" class="modal fade">
          <div role="document" class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h4 id="login-modalLabel" class="modal-title">Participant View</h4>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
              </div>
              <p><center>You are going to leave this organizer view and need to verify your info to go back to this page. Do you want to proceed? </center></p>
              <center><div class="form-group"><br>
              <a href="listresources-participant.php" class="btn btn-outline-success">Yes</a>
            </div></center>
            </div>
          </div>
        </div>
        <!-- participant view end-->
