      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">List of Participants</h2>
          </div>
        </div>
        ...
        <section class="col-lg-12">
          <div class="block">
            ...
            <a href="add-participant.php" class="btn btn-primary">+ Add Participant</a>&emsp;
            <a href="deleted-listparticipant.php" class="btn btn-secondary">Deleted</a>
            </div>
            <div>
              <span class="input-group-addon">Search : </span>
              <input type="text" name="search_text" id="search_text" placeholder="Search by NFC ID, Name or IC" class="form-control" />
            </div>
            <hr></hr>
          <div id="result"></div>
          </div>
