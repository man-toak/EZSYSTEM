      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">List of Events</h2>
          </div>
        </div>
        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            ...
            <a href="add-eventt.php" class="btn btn-primary"><i class="fa fa-add"></i>+ Add Event</a>&emsp;
            <a href="deleted-listevent.php" class="btn btn-secondary">Deleted</a>
            </div>
            <div>
