    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="participant-resources.php"> <i class="icon-contract"></i>Resources</i></a></li>
        </ul>
      </nav>
      ...
      <div class="page-content">
        ...
        <section class="col-lg-12">
          <div class="block">
            <div class="h2 text-center">Available Resources</div>
            <div>
