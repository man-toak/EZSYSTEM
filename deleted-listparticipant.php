      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">List of Deleted Participants</h2>
          </div>
        </div>
        ...
        <section class="col-lg-12">
          <div class="block">
            ...
            <a href="listparticipant.php" class="btn btn-primary">List Participant</a>
            </div>
            <div>
              <span class="input-group-addon">Search : </span>
              <input type="text" name="search_text" id="search_text" placeholder="Search by Name or IC" class="form-control" />
            </div>
            <hr></hr>
          <div id="result"></div>
          </div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"fetch_deleted_participant.php",
   method:"POST",
   data:{query:query},
