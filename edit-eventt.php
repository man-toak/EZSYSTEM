...
<html>
  ...
  <?php
    ...
    $result1 = mysqli_query($conn,$update) or die ('events edit sql');
      if ($result1){
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Edit Event</h2>
          </div>
        </div>
        ...
        <section class="col-lg-12">
          <div class="block">
            <div class="text-left"><a class="btn btn-secondary btn-sm" href="listevent.php"><i class="fas fa-long-arrow-alt-left"></i> back</a></div>
            <div class="h2 text-center">Info Event</div>
                        <?php if($message != "") {
                        echo
            ...
            <div class="table-responsive">
              <form action="" method="post" autocomplete="off">
                <table class="table">
                  <tbody>
                    <div class="col-sm-9">
                      ...
                      <tr>
                        <th>Title</th>
                        <td><input placeholder="Enter a title" class="form-control" type="text" name="title" value="<?php echo $row2['title'] ?>" required></td>
                        </tr>

                      <tr>
                        <th>Date</th>
                        <td><input class="form-control" type="date" name="date" value="<?php echo $row2['date'] ?>" required></td>
                        </tr>

                        <tr>
                        <th>Start Time</th>
                        <td><input placeholder="Selected time" type="time" name="time" class="form-control" value="<?php echo $row2['time'] ?>" required></td>
                        </tr>

                        <tr>
                        <th>End Time</th>
                        <td><input placeholder="Selected time" type="time" name="end" class="form-control" value="<?php echo $row2['end'] ?>" required></td>
                        </tr>

                          <tr>
                          <th>Venue</th>
                          <td><input placeholder="Enter a venue" class="form-control" type="text" name="venue" value="<?php echo $row2['venue'] ?>" required>
                          </td>
                          </tr>

                          <tr>
                          <th>Capacity</th>
                          <td><input placeholder="How much seats provided?" class="form-control" name="seat" value="<?php echo $row2['seat'] ?>" required>
                          </td>
                          </tr>
                ...
                <br>
                <center>
                <input type="submit" value="EDIT" class="btn btn-success js-scroll-trigger" id="add" name="edit">
                </center>
                </form>
              </div>
