...
$query = "SELECT `date` FROM `events` ORDER BY date ASC";
$result = mysqli_query($conn,$query) or die('SQL error count down!');
        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div>
              ...
              <input type="text" name="search_text" id="search_text" placeholder="Search by Organizer Name" class="form-control" />
            </div>
            <br>
            <hr></hr><br>
          <div id="result"></div>
