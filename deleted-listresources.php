      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">List of Deleted Resources</h2>
          </div>
        </div>
        ...
        <section class="col-lg-12">
          <div class="block">
            ...
            <a href="listresources.php" class="btn btn-primary">List Resources</a>
            </div>
            <div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"fetch_deleted_resources.php",
   method:"POST",
   data:{query:query},
